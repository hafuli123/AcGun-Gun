...
//  delay_ms(100);
    ...
    WriteCmd(0xAE); //display off  关闭显示，先设置好其他再打开

    WriteCmd(0x20); //Set Memory Addressing Mode    寻址模式，页寻址 默认也是页寻址
    ...
    WriteCmd(0x14); //
    WriteCmd(0xaf); //--turn on oled panel  开启显示
}
